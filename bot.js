...
client.on("userUpdate", async (stg, yeni) => {
  var sunucu = client.guilds.cache.get('796675833787973642'); // Buraya Sunucu ID
  var uye = sunucu.members.cache.get(yeni.id);
  var tag = "✯"; // Buraya Ekip Tag
  var tagrol = "796725579839176704"; // Buraya Ekip Rolünün ID
  var kanal = "796680542937677836"; // Loglanacağı Kanalın ID
